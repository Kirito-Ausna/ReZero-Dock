...
parser.add_argument('--no_sidechain', action='store_true', default=False, help='Compute sidechain RMSD or not')
...
# Best of Top 5 rmsd, sc_rmsd, residue_rmsd and centroid distance
    ...
    top5_performance_metrics.update({
        ...
        f'{overlap}top5_mean_rmsd': top5_rmsds.mean(),
        ...
        f'{overlap}top5_mean_centroid': top5_centroid_distances.mean().__round__(2), # TODO: check if this is correct
    ...
    if not args.no_sidechain:
        top5_performance_metrics.update({
            f'{overlap}top5_mean_sc_rmsd': top5_sc_rmsds.mean(),
            ...
            f'{overlap}top5_mean_residue_rmsd': top5_residue_rmsds.mean(),
...
# Best of Top 10
    ...
    top10_performance_metrics.update({
        ...
        f'{overlap}top10_mean_rmsd': top10_rmsds.mean(),
        ...
        f'{overlap}top10_mean_centroid': top10_centroid_distances.mean().__round__(2), # TODO: check if this is correct
    ...
    if not args.no_sidechain:
        top10_performance_metrics.update({
            f'{overlap}top10_mean_sc_rmsd': top10_sc_rmsds.mean(),
            ...
            f'{overlap}top10_mean_residue_rmsd': top10_residue_rmsds.mean(),
