...
def parse_train_args():
    ...
    parser.add_argument('--run_name', type=str, default='visualdock_debug', help='')
    ...
    parser.add_argument('--chi_annealed_temp', type=float, default=3, help='Annealed temperature for the diffusion')
    parser.add_argument('--diffusion_cache_folder', type=str, default='data/diffusion_cache', help='Folder for the diffusion cache')
    parser.add_argument('--chi_mode', type=str, default='ode', help='Mode of diffusion')
